            ...
            <div class="modal-body">
                <form action="{{url("admin/raspModify")}}#menu1" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <select id="rasp_idfack" name="rasp_idfack" class="form-control">
                            @foreach ($fucks as $fuck)
                                <option value="{{ $fuck->Number }}">{{ $fuck->Name }}</option>
                            @endforeach
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="rasp_idgroup" id="rasp_idgroup">
                            @foreach ($groups as $group)
                    ...
                    <div class="form-group">
                        <label for="rasp_course">Course:</label>
                        <input type="text" class="form-control" id="rasp_course" placeholder="Введите id группы" name="rasp_course">
            ...
            <div class="modal-body">
                <form action="{{url("admin/groupModify")}}#menu3" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden"  value="" class="form-control" id="group_id" name="group_id" placeholder="Введите id группы">
                    </div>
